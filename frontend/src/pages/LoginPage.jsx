...
const LoginPage = () => {
  ...
  return (
    <div style={{background:"#ebf9ed" , filter: `invert(${theme})`}} className="h-[100vh] grid lg:grid-cols-2 ">
      {/* left side */}
      <div className="m-auto w-[44vw] flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="h-[60vh] max-w-md space-y-2  w-[66%]">
          {/* LOGO */}
          <div className="text-center mb-2">
            <div className="flex flex-col items-center gap-1 group">
              <div className="size-12 rounded-xl bg-customBlue flex items-center justify-center 
          ...
          <form onSubmit={handleSubmit} className="">
           <div className="form-control">
            ...
            <button style={{ color: '#355F2E' }} type="submit" className="mt-2 btn bg-customBlue w-full hover:bg-customBlue2" disabled={isLogingin}>
              {isLogingin ? (
                <>
